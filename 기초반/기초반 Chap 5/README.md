...
## [1](#toc). Objected Oriented Programming (OOP, 객체지향 프로그래밍)
...
#### [1-4-1](#toc). Class Variable(클래스 속성)
...
#### [1-5-1](#toc). Static Method(정적 메서드)
...
#### [1-5-2](#toc). Class Method(클래스 메서드)
...
#### [1-5-3](#toc). Magic Method(Special Method)
